...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-^vkobyb13gk8zu&4m=r1)a9^=+xetuo3cb_-e7mglag%*x+amz')
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # FIXED: WhiteNoise (capital N)
...
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Changed from 'assets' to 'staticfiles'

# FIXED: Corrected typo in STATICFILES_STORAGE
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://autoworld-red.vercel.app",
    "http://localhost:3000",
    "http://localhost:5173",
    "http://127.0.0.1:3000",
    "http://127.0.0.1:5173",
